...
class TestHTMLNode(unittest.TestCase):
    def test_props_to_html_1(self):
        ...
        self.assertEqual(
            node_props_to_html, ' href="https://www.google.com" target="_blank"'
        )

    def test_props_to_html_2(self):
        node = HTMLNode(
            "a", "some random value", None, dict([("href", "https://www.google.com")])
        )
        node_props_to_html = node.props_to_html()
        self.assertEqual(node_props_to_html, ' href="https://www.google.com"')
